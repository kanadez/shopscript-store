...
class shopFrontendCartSaveController extends waJsonController
{
    public function execute()
    {
        ...
        if ($q = waRequest::post('quantity', 0, 'int')) {
            ...
            $this->response['item_total_no_currency'] = $cart->getItemTotal($item_id);
            $this->response['item_discounts_total_no_currency'] = $cart->getItemDiscountTotal($item_id);
            ...
            $this->response['item_total_no_currency'] = $cart->getItemTotal($item['parent_id']);
            $this->response['item_discounts_total_no_currency'] = $cart->getItemDiscountTotal($item['parent_id']);
        }
        ...
        $this->response['total_no_currency'] = $total;
