...
class shopCheckoutContactinfo extends shopCheckout
{
    ...
    public function display()
    {
        ...
        if ($this->isDigital()){
            unset($this->form->fields["firstname"]);
            unset($this->form->fields["lastname"]);
            unset($this->form->fields["phone"]);
            unset($this->form->fields["address.shipping"]);
            unset($this->form->fields["address.billing"]);
        }
