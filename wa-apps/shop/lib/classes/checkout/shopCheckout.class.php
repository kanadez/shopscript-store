...
abstract class shopCheckout
{
    ...
    protected $step_id;
    protected $regular_url = "checkout/";
    protected $digital_url = "checkout_digital/";
...
//        ));
    ...
    protected function isDigital(){
        $response = wa()->getRouting()->getCurrentUrl() == $this->digital_url ? TRUE : FALSE;
