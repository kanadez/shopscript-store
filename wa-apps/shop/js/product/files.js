(function ($) {
    $.product_files = {
        ...
        init: function (options) {
            ...
            var tab = $('#s-product-edit-menu .files');
            ...
            $.product.editTabImagesBlur = function (path) {
                $('#fileupload_files').fileupload('destroy');
            };
        ...
        initImageList: function (options) {
            this.image_list = $(options.image_list || '#s-product-file-list');
            this.image_list.html(tmpl('template-product-file-list', {
